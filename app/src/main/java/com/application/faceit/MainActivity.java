package com.application.faceit;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                bitmap = getBitmapFromAsset(this, "Photo 1.jpg");
                break;
            case 1:
                bitmap= getBitmapFromAsset(this, "Image2.png");
                break;
            case 2:
                bitmap = getBitmapFromAsset(this, "Image3.png");
                break;
        }
        if (bitmap  != null) {
